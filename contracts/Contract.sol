...
contract Complaint {
        ...
        public
    {
        ...
        newComplaint.discardRemark = "Fake Complaint";
    ...
    function discardComplaint(uint256 _id, string memory _discardRemark)
        public
        onlyOfficer
    {
        require(
        ...
        Complaints[_id].discardRemark = _discardRemark;
    }
